    ...
    <b-container align-h="center" id="attributesSection">
      <b-row align-h="center">
        <b-col md="auto">
          ...
          <p class="dotLoad">
            HTML/CSS <span>.</span><span>.</span><span>.</span><span>.</span>
          </p>
          <p class="dotLoad">
            Wordpress <span>.</span><span>.</span><span>.</span><span>.</span>
          </p>
          <p class="dotLoad">
          ...
          <p class="dotLoad lastDot">
            React/Vue <span>.</span><span>.</span><span>.</span><span>.</span>
          </p>
          <p class="dotLoad lastDot">
            NextJS/NuxtJS <span>.</span><span>.</span><span>.</span
            ><span>.</span>
          </p>
          <p class="dotLoad lastDot">
            DNS Management <span>.</span><span>.</span><span>.</span
            ><span>.</span>
          </p>
          <p class="dotLoad lastDot">
            Project Management <span>.</span><span>.</span><span>.</span
            ><span>.</span>
          </p>
        </b-col>
      </b-row>
...
.dotLoad span:nth-child(2) {
  animation-delay: 0.2s;
}

.dotLoad span:nth-child(3) {
